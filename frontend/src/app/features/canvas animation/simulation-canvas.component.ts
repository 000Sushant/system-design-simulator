...
export class SimulationCanvasComponent implements OnDestroy {
  public tiltStyle = 'perspective(1200px) rotateX(0deg) rotateY(0deg) scale3d(1,1,1)';
  ...
  addLog(): void {
    const ips = ['192.168.1.45', '172.16.0.84', '203.0.113.12', '198.51.100.5', '192.168.2.14'];
  ...
  onMouseLeave(): void {
    ...
    this.tiltStyle = 'perspective(1200px) rotateX(0deg) rotateY(0deg) scale3d(1,1,1)';
  }
}
