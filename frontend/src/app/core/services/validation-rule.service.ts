...
export class ValidationRuleService {
  ...
  validate(
    ...
    if (source.type === 'vpc' && !['ec2', 'ecs', 'lambda', 'rds', 'elastiCache', 'autoScalingGroup', 'elb', 'natGateway', 'eks', 'aurora', 'msk', 'efs', 'secretsManager', 'mq', 'redshift', 'openSearch', 'fsx', 'ecr', 'privateLink'].includes(target.type)) {
